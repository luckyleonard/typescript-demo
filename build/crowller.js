...
var newsAnalyzer_1 = __importDefault(require("./newsAnalyzer"));
var Crowller = /** @class */ (function () {
    function Crowller(url, analyzer) {
        this.url = url;
        this.analyzer = analyzer;
        this.filePath = path_1.default.resolve(__dirname, '../data/news.json');
        this.runSpider();
    }
    //抽离私有file path
    ...
    Crowller.prototype.runSpider = function () {
        return __awaiter(this, void 0, void 0, function () {
...
var analyzer = newsAnalyzer_1.default.getInstance();
